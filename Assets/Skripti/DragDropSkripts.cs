...
using UnityEngine;
//Jāiemportē, lai varētu lietot visus I interfeisus
...
public class DragDropSkripts : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler {
    ...
    //Velkamam objektam piestiprināta CanvasGroup komponente
    ...
    void Start()
    {
        //Piekļūst objektam piestiprinātajai CanvasGroup komponentei
